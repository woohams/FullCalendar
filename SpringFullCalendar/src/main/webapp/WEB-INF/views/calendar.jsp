            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="col-xs-4" for="edit-category">구분</label>
                                <select class="inputModal" name="edit-category" id="edit-category">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <textarea rows="4" cols="50" class="inputModal" name="edit-content"
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <select class="filter" id="category_filter" multiple="multiple">
                            <option value="카테고리1">카테고리1</option>
                            <option value="카테고리2">카테고리2</option>
                            <option value="카테고리3">카테고리3</option>
                            <option value="카테고리4">카테고리4</option>
